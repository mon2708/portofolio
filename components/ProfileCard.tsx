  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative w-full max-w-[800px] aspect-[4/5] rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl transition-transform duration-200 ease-out flex flex-col"
        style={{
